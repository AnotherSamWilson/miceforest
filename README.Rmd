...
[![DEV_Version_Badge](https://img.shields.io/badge/Dev-2.0.1-blue.svg)](https://pypi.org/project/miceforest/)
...
We can also create multiple ```KernelDataSet```s, along with easy ways to compare them:
...
```
```{r,echo=FALSE,out.width="600px"}
knitr::include_graphics("examples/mean_convergence.png")
```
