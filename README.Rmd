...
[![DEV_Version_Badge](https://img.shields.io/badge/Dev-3.1.1-blue.svg)](https://pypi.org/project/miceforest/)
...
~86% after the first iteration. The accuracy kind of floundered around afterwards. However, notice the accuracy we achieved at the last iteration, after parameter tuning.
